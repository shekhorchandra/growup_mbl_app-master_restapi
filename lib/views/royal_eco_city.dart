...
class RoyalEcoCityPage extends StatefulWidget {
  ...
  @override
  State<RoyalEcoCityPage> createState() => _RoyalEcoCityPageState();
}

class _RoyalEcoCityPageState extends State<RoyalEcoCityPage> {
  ...
  final List<Map<String, String>> _properties = [
    {
      ...
      "image": "https://growupagro.tech/storage/uploads/property/packages/68d986af8413e.jpeg",
      "beds": "15",
      "baths": "10",
      "size": "12000 sqft",
    },
