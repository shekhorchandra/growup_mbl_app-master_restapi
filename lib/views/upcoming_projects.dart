...
class _UpcomingProjectsPageState extends State<UpcomingProjectsPage> {
  ...
  Future<List<UpcomingProject>> fetchUpcomingProjects() async {
    ...
    if (response.statusCode == 200) {
      ...
      _allProjects =
          projectsJson.map((json) => UpcomingProject.fromJson(json)).toList();
  ...
  Widget _buildProjectCard(
      {required UpcomingProject project, required BuildContext context}) {
    return Card(
                ...
                children: [
                  ...
                  Table(
                    ...
                    children: [
                      ...
                      _buildTableRow(
                          'Remaining', formatAmount(project.remainingGoal)),
                      ...
                      // _buildTableRow(
                      //     'Projected', project.projected ?? 'N/A'),
                      _buildTableRow('ROI',
                          project.annualRoi != null ? '${project.annualRoi}%' : 'N/A'),
                      _buildTableRow(
                        'Status',
                      ...
                      onPressed: _loadingProjectIds.contains(project.id)
                        ...
                        try {
                          ...
                          if (investorCode == null ||
                              investorCode.isEmpty) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                  content:
                                  Text('Investor code not found.')),
                            );
                            return;
                          }
