...
class ResidencialCityPage extends StatefulWidget {
  ...
  @override
  State<ResidencialCityPage> createState() => _ResidencialCityPageState();
}

class _ResidencialCityPageState extends State<ResidencialCityPage> {
  final ScrollController _scrollController = ScrollController();
  bool _showBackToTopButton = false;

  // 🔹 Static dummy property list
  ...
  // 🔹 Property Card (copied style from AllPropertiesPage)
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      _buildStat(FontAwesomeIcons.bed, property["beds"]!),
                      _buildStat(FontAwesomeIcons.bath, property["baths"]!),
                      _buildStat(
                  ...
                  // Full-width CustomButton (same as AllPropertiesPage)
                  SizedBox(
                    width: double.infinity,
                    child: CustomButton(
                      text: "Coming Soon...",
