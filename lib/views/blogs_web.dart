...
//
//
// class BlogsWebViewPage extends StatefulWidget {
//   const BlogsWebViewPage({Key? key}) : super(key: key);
//
//   @override
//   State<BlogsWebViewPage> createState() => _BlogsWebViewPageState();
// }
//
// class _BlogsWebViewPageState extends State<BlogsWebViewPage> {
...
//         title: const Text("Blogs", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.white),),
//         centerTitle: true,
//         leading: IconButton(
